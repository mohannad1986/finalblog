...
<body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="dropdown dropdown-notification nav-item  dropdown-notifications">
                            <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                ...
                                <span
                                    class="badge badge-pill badge-default badge-danger
                                     badge-default badge-up badge-glow   notif-count"
                                    data-count="9">9</span>
                            </a>
    ...
    <script>
            ...
            var pusher = new Pusher('186a53855c556d7e4827', {
            cluster: 'ap2'
            });
